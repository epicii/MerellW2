...
local anims = {'Left electrofied', 'EMP Blue', 'EMP Green', 'Right electrofied'}
...
function onCountdownTick(counter)
	if counter == 1 then
		...
		for nS = 0, 3 do
			makeAnimatedLuaSprite('fakeNS'..nS, 'EMP_Assets', getPropertyFromGroup('playerStrums', nS, 'x') - 30, getPropertyFromGroup('playerStrums', nS, 'y'))
			ddAnimationByPrefix('fakeN'..n, 'static',  anims[n+1], 50, false)
